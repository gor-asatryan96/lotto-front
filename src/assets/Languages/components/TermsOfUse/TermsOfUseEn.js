    ...
    return (
        ...
        <div className="textContainer">
          ...
          <div className="textBody">
            ...
            <p> Every {GAME_DURATION} minutes Chukua Tano draws numbers consisting of 5 digits from 0 to 9.</p>
            ...
            <p> 1. If one digit matches, the user wins 1 000 TZS. (bet x1).</p>
            <p> 2. If two digits match, the user wins 2 000TZS. (bet x2).</p>
            <p> 3. If three digits match, the user wins 10 000TZS. (bet x10).</p>
            <p> 4. If four digits match, the user wins 100 000 TZS. (bet x100).</p>
            <p className='marginBottom'> 5. In case all five digits match, the user wins 5 000 000 TZS.(bet x5000).</p>
            ...
            <p className='marginBottom'>5. 12345 (five matches)</p>
